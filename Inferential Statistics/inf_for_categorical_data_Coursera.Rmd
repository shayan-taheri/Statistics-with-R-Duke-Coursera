...
us12 %>%
  summarise(us_atheist_rate = sum(response == "atheist") / n()) 

atheism%>%
  summarise(glo_atheist_rate = sum(response == "atheist") / n())
...
inference(y =response, x = year, data = spain, statistic = "proportion", type = "ht", null = 0, alternative = "twosided", method = "theoretical", success = "atheist")
```
...
inference(y =response, x = year, data = us, statistic = "proportion", type = "ht", null = 0, alternative = "twosided", method = "theoretical", success = "atheist")
